...
- **Nginx CVEs that Grype still flags against our build**: even after the CVE-2026-42945 backport, Grype keeps several flagged against the `nginx 1.25.5` package because the version string didn't change: CVE-2023-44487 (HTTP/2 Rapid Reset — high EPSS, broadly exploited), CVE-2026-27651, CVE-2026-27654, CVE-2026-32647, and a handful of CVE-2026-* mediums. The proper remediation track for these is **VEX attestation** (declaring them `not_affected` or `fixed` with justification) so VEX-aware scanners drop them — to be added.
